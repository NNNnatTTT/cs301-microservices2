...
// Unless all fields are completed, account remains in 'Draft'
// Update checks if all fields are completed. If yes, status changes to ready
// On frontend, agent sees the status reflected as ready and can press a button to move to Pending
// In pending, no edits can be made
// IF passed, account is active. Else, account reverts to Draft
